...
<?php if ( $show_content ) : ?>
	...
	<?php if ( ( isset( $materials ) ) && ( !empty( $materials ) ) ) : ?>
		<div id="learndash_lesson_materials" class="learndash_lesson_materials">
			<h2><?php printf( esc_html_x( '%s Materials', 'Lesson Materials Label', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson' ) ); ?></h2>
		...
		<div id="learndash_quizzes" class="learndash_quizzes">
			...
			<?php foreach ( $quizzes as $quiz ) : ?>
				<div id='post-<?php echo esc_attr( $quiz['post']->ID ); ?>' class='col-sm-12 <?php echo esc_attr( $quiz['sample'] ); ?>'>
					<div class="list-count col-sm-1"><?php echo esc_attr( $quiz['sno'] ); ?></div>
