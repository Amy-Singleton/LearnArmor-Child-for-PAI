		...
		<?php if ( ! empty( $user_courses ) ) : ?>
			...
			<?php foreach ( $user_courses as $course_id ) : ?>
				...
				<div id='course-<?php echo esc_attr( $user_id ) . '-' . esc_attr( $course->ID ); ?>'>
					...
					<h2 class="col-sm-12">
						<div class="col-sm-10 learndash-course-link"><a href="<?php echo esc_attr( $course_link ); ?>"><?php echo $course->post_title; ?></a></div>
						<div class="col-sm-1 learndash-course-certificate"><?php
						...
						?></div>
						<div class="col-sm-1 learndash-course-status">
							<span class="<?php echo esc_attr( $status); ?> col-sm-1 glyphicon" aria-hidden="true"></span>
						</div>
						<div class="flip" style="clear: both; display:none;">
							...
							<?php if ( ! empty( $quiz_attempts[ $course_id ] ) ) : ?>
								<div class="learndash_profile_quizzes clear_both">
									...
									<div class="col-sm-12 learndash_profile_quiz_heading">
										<div class="col-sm-6 quiz_title"><?php echo LearnDash_Custom_Label::get_label( 'quizzes' ); ?></div>
										<div class="col-sm-1 certificate"><?php esc_html_e( 'Certificate', 'learndash' ); ?></div>
										<div class="col-sm-1 scores"><?php esc_html_e( 'Score', 'learndash' ); ?></div>
										<div class="col-sm-2 statistics"><?php esc_html_e( 'Statistics', 'learndash' ); ?></div>
										<div class="col-sm-2 quiz_date"><?php esc_html_e( 'Date', 'learndash' ); ?></div>
									</div>
									...
									<?php foreach ( $quiz_attempts[ $course_id ] as $k => $quiz_attempt ) : ?>
										...
										<?php if ( ! empty( $quiz_title ) ) : ?>
											<div class='col-sm-12 <?php echo esc_attr( $status ); ?>'>
												...
												<div class="col-sm-2 quiz_date"><?php echo learndash_adjust_date_time_display(  $quiz_attempt['time'] ); ?></div>
